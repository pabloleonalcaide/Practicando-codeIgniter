...
class Ion_auth{
	...
	public function __call($method, $arguments)
	{
		...
		switch($method){
			case 'create_user': return call_user_func_array(array($this, 'register'), $arguments);
			case 'update_user': return call_user_func_array(array($this, 'update'), $arguments);
			default: return call_user_func_array( array($this->ion_auth_model, $method), $arguments);
		}
